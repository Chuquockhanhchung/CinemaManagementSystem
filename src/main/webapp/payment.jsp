...
<form action="ticket" method="post">
    <input type="text" value="${sessionScope.user.CustomerID}" name="customerId">
    <input type="text" value="${sessionScope.time}" name="showtimeID">
                                                                                ...
                                                                                <div class="qr qr-size-default"
                                                                                    ...
                                                                                    <div class="qr-inner"
                                                                                        ...
                                                                                        <img class="qrcodeimg-modal"
                                                                                             src="https://img.vietqr.io/image/vietinbank-104877396758-qr_only.jpg?amount=<%= customCurrency %>&addInfo=${sessionScope.user.name}%20${sessionScope.user.CustomerID}"
                                                                                             alt="QR CODE">
                                                                                    </div>
                                                                                </div>
                                                                                <div
