                                                                            ...
                                                                            <div class="qr qr-size-default"
                                                                                ...
                                                                                <div class="qr-inner"
                                                                                    ...
                                                                                    <img class="qrcodeimg-modal"
                                                                                         src="https://img.vietqr.io/image/vietinbank-104877396758-qr_only.jpg?amount=<%= currencyFormat.format(ticket.getTicketPrice()).replace("₫", "")%>&addInfo=${sessionScope.user.name}%20${sessionScope.user.idCustomer}"
                                                                                         alt="QR CODE">
                                                                                </div>
                                                                            </div>
                                                                            <div
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="st_cherity_btn float_left">
                                <ul>
                                    <li><a href="confirmation_screen.jsp">Tiến hành thanh toán</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
