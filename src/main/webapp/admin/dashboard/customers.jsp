            ...
            <ul class="metismenu" id="menu">
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="https://ventic.dexignzone.com/codeigniter/demo/orders_list">Orders list</a>
                        </li>
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="https://ventic.dexignzone.com/codeigniter/demo/post_details">Post Details</a>
                        </li>
                        <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Email</a>
                            <ul aria-expanded="false">
                                <li><a
                                        href="https://ventic.dexignzone.com/codeigniter/demo/email_compose">Compose</a>
                                </li>
                                <li><a href="https://ventic.dexignzone.com/codeigniter/demo/email_inbox">Inbox</a>
                                </li>
                                <li><a href="https://ventic.dexignzone.com/codeigniter/demo/email_read">Read</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Shop</a>
                            <ul aria-expanded="false">
                                ...
                                <li><a href="https://ventic.dexignzone.com/codeigniter/demo/ecom_product_details">Product
                                    Details</a></li>
                                <li><a
                                        href="https://ventic.dexignzone.com/codeigniter/demo/ecom_product_order">Order</a>
                                </li>
                                <li><a
                                        href="https://ventic.dexignzone.com/codeigniter/demo/ecom_checkout">Checkout</a>
                                </li>
                                <li><a
                                        href="https://ventic.dexignzone.com/codeigniter/demo/ecom_invoice">Invoice</a>
                                </li>
                                <li><a
                                        href="https://ventic.dexignzone.com/codeigniter/demo/ecom_customers">Customers</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="https://ventic.dexignzone.com/codeigniter/demo/add_content">Add Content</a>
                        </li>
                        <li><a href="https://ventic.dexignzone.com/codeigniter/demo/menu">Menus</a></li>
                        <li><a href="https://ventic.dexignzone.com/codeigniter/demo/email_template">Email
                            Template</a></li>
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="https://ventic.dexignzone.com/codeigniter/demo/button_group">Button Group</a>
                        </li>
                        ...
                        <li><a href="https://ventic.dexignzone.com/codeigniter/demo/progressbar">Progressbar</a>
                        </li>
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="https://ventic.dexignzone.com/codeigniter/demo/noui_slider">Noui Slider</a>
                        </li>
                        ...
                        <li><a href="https://ventic.dexignzone.com/codeigniter/demo/lightgallery">Light Gallery</a>
                        </li>
                    </ul>
                </li>
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="https://ventic.dexignzone.com/codeigniter/demo/form_element">Form Elements</a>
                        </li>
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="https://ventic.dexignzone.com/codeigniter/demo/table_bootstrap">Bootstrap</a>
                        </li>
                        <li><a href="https://ventic.dexignzone.com/codeigniter/demo/table_datatable">Datatable</a>
                        </li>
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="https://ventic.dexignzone.com/codeigniter/demo/page_lock_screen">Lock
                            Screen</a></li>
    ...
    <div class="content-body default-height">
        ...
        <div class="container-fluid">
            ...
            <div class="form-head mb-4 d-flex flex-wrap align-items-center">
                <div class="me-auto">
                    <h2 class="font-w600 mb-0">Customer List</h2>
                    ...
                    <div class="table-responsive rounded">
                        <table id="example5" class="table customer-table display mb-4 fs-14 card-table">
                            ...
                            <tr>
                                ...
                                <td>Medan Indonesia</td>
                                <td>04/08/2020 12:34 AM</td>
                                <td class="text-secondary font-w500">$623,55</td>
                                <td>
                                    <div class="d-flex">
                                        <a href="javascript:void(0);">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <tr>
                                ...
                                <td>Medan Indonesia</td>
                                <td>04/08/2020 12:34 AM</td>
                                <td class="text-secondary font-w500">$246,45</td>
                                <td>
                                    <div class="d-flex">
                                        <a href="javascript:void(0);">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <tr>
                                ...
                                <td>Medan Indonesia</td>
                                <td>04/08/2020 12:34 AM</td>
                                <td class="text-secondary font-w500">$623,66</td>
                                <td>
                                    <div class="d-flex">
                                        <a href="javascript:void(0);">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <tr>
                                ...
                                <td>Medan Indonesia</td>
                                <td>04/08/2020 12:34 AM</td>
                                <td class="text-secondary font-w500">$56,125</td>
                                <td>
                                    <div class="d-flex">
                                        <a href="javascript:void(0);">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
