                    ...
                    <ul class="metismenu" id="menu">
                        ...
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                ...
                                <li><a href="dashboard/reviews.jsp">Reviews</a></li>
                            </ul>
                        ...
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <li><a href="Apps/app_calender.jsp">Calendar</a></li>
                            </ul>
                        </li>
                        ...
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                ...
                                <li><a href="https://ventic.dexignzone.com/codeigniter/demo/add_content">Add Movie</a>
                                </li>
                                ...
                                <li><a href="https://ventic.dexignzone.com/codeigniter/demo/add_blog">Add Event</a></li>
                                    ...
                                    <div class="card event-bx">
                                        ...
                                        <div class="card-body dz-scroll loadmore-content pt-0" id="EventListContent">
                                            ...
                                            <div class="media event-list pb-3 border-bottom mb-3">
                                                ...
                                                <div class="media-body">
                                                    <h4 class="fs-18 mb-sm-0 mb-2"><a href="javascript:void(0);"
                                                                                      class="text-black">Google I/O Developer Conference</a></h4>
                                                    <span class="fs-14 d-block mb-sm-2 mb-2 text-secondary">Medan,
                                                        Indonesia</span>
                                                    <p class="fs-12">Lorem ipsum dolor sit amet, consectetur adipiscing
                                                        elit, sed do eiusmod tempor incididunt ut labore et dolore magna
                                            ...
                                            <div class="media event-list pb-3 border-bottom mb-3">
                                                ...
                                                <div class="media-body">
                                                    <h4 class="fs-18 mb-sm-0 mb-2"><a href="javascript:void(0);"
                                                                                      class="text-black">Apple Worldwide Developers Conference
                                                            (WWDC)</a></h4>
                                                    <span class="fs-14 d-block mb-sm-2 mb-2 text-secondary">Medan,
                                                        Indonesia</span>
                                                    <p class="fs-12">Lorem ipsum dolor sit amet, consectetur adipiscing
                                            ...
                                            <div class="media event-list pb-3 border-bottom mb-3">
                                                ...
                                                <div class="media-body">
                                                    <h4 class="fs-18 mb-sm-0 mb-2"><a href="javascript:void(0);"
                                                                                      class="text-black"> TED Global Summit 2020</a></h4>
                                                    <span class="fs-14 d-block mb-sm-2 mb-2 text-secondary">Medan,
                                                        Indonesia</span>
                                                    <p class="fs-12">Lorem ipsum dolor sit amet, consectetur adipiscing
                                                        elit, sed do eiusmod tempor incididunt ut labore et dolore magna
                                            ...
                                            <div class="media event-list pb-3 border-bottom mb-3">
                                                ...
                                                <div class="media-body">
                                                    <h4 class="fs-18 mb-sm-0 mb-2"><a href="javascript:void(0);"
                                                                                      class="text-black"> Adobe MAX Creative Conference</a></h4>
                                                    <span class="fs-14 d-block mb-sm-2 mb-2 text-secondary">Medan,
                                                        Indonesia</span>
                                                    <p class="fs-12">Lorem ipsum dolor sit amet, consectetur adipiscing
                                                        elit, sed do eiusmod tempor incididunt ut labore et dolore magna
