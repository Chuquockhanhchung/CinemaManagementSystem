<%-- 
    Document   : form_pickers
    Created on : May 26, 2024, 9:21:46 PM
    Author     : datla
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <link href="public/assets/vendor/clockpicker/css/bootstrap-clockpicker.min.css" rel="stylesheet" type="text/css" />

        <link href="public/assets/vendor/jquery-asColorPicker/css/asColorPicker.min.css" rel="stylesheet" type="text/css" />

        <link href="public/assets/vendor/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css" rel="stylesheet" type="text/css" />

        <link href="public/assets/vendor/pickadate/themes/default.css" rel="stylesheet" type="text/css" />

        <link href="public/assets/vendor/pickadate/themes/default.date.css" rel="stylesheet" type="text/css" />
                            ...
                            <ul class="navbar-nav header-right">
                                ...
                                <li class="nav-item dropdown header-profile">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a href="https://ventic.dexignzone.com/codeigniter/demo/page_login" class="dropdown-item ai-icon">
    ...
    ***********************************-->
        ...
        <script src="public/assets/vendor/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js"></script>
        <script src="public/assets/vendor/pickadate/picker.js"></script>
        <script src="public/assets/vendor/pickadate/picker.time.js"></script>
        <script src="public/assets/vendor/pickadate/picker.date.js"></script>
        <script src="public/assets/js/plugins-init/bs-daterange-picker-init.js"></script>
        <script src="public/assets/js/plugins-init/clock-picker-init.js"></script>
        <script src="public/assets/js/plugins-init/jquery-asColorPicker.init.js"></script>
        <script src="public/assets/js/plugins-init/material-date-picker-init.js"></script>
        <script src="public/assets/js/plugins-init/pickadate-init.js"></script>
