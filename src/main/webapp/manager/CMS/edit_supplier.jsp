            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <%
                        ...
                        Supplier s = sd.getSupplierByID(SupplierID);
                    %>
                    <form method="post" action="../../editsupplier">
                        <input type="text" name="SupplierID" value="<%= s.getSupplierID()%>">
                        <div class="row">
                            <div class="mb-3 col-sm-8">
                                <label class="form-label">Tên nhà cung cấp</label>
                                <input type="text" class="form-control" placeholder="Tên Sản Phẩm"
                                       name="SupplierName" value="<%=s.getSupplierName()%>">
                            </div>
                            <div class="col-xl-8">
                                <div class="filter cm-content-box box-primary">
                                    ...
                                    <div class="cm-content-body form excerpt">
                                        <div class="card-body">
                                            ...
                                            <input type="text" class="form-control"
                                                   name="PhoneNumber" value="<%=s.getPhoneNumber()%>">
                                        </div>
                                    </div>
                                    <input type="submit" class="btn btn-primary" value="EditSupplier">
                                </div>
