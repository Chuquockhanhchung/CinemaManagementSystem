    ...
    <div class="container-fluid">
      <div class="page-titles">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="editCombo">Sửa combo</a></li>
        </ol>
      </div>
      <!-- Row -->
      <div class="row">
          ...
          <div class="row">
            <div class="col-xl-11">
              <form action="editCombo" method="post">
                <div class="filter cm-content-box box-primary" style="display: none">

                  <div class="cm-content-body   form excerpt">
                    <div class="card-body">
                      <label class="form-label">ID combo</label>
                      <input type="text" value="${sessionScope.combo.getId()}" name="id"
                ...
                <div class="filter cm-content-box box-primary">
                  ...
                  <div class="cm-content-body   form excerpt">
                    <div class="card-body">
                      ...
                      <input type="text" value="${sessionScope.combo.getName()}" name="name"
                             class="form-control mb-3" placeholder="Tên combo">
                        ...
                        <c:if test="${sessionScope.product != null}">
                          <c:forEach items="${sessionScope.product}" var="i">
                            <div class="form-check mb-sm-3 mb-1">
                              ...
                              <c:forEach items="${requestScope.id}" var="p">
                ...
                <div class="filter cm-content-box box-primary">
                  ...
                  <div class="cm-content-body   form excerpt">
                    <div class="card-body">
                      ...
                      <input type="text" value="${sessionScope.combo.getDescription()}"
                ...
                <div class="filter cm-content-box box-primary">
                  ...
                  <div class="cm-content-body   form excerpt">
                    <div class="card-body">
                      ...
                      <input type="text" value="${sessionScope.combo.getImg()}"
                ...
                <div class="filter cm-content-box box-primary">
                  ...
                  <div class="cm-content-body   form excerpt">
                    <div class="card-body">
                      ...
                      <input type="text" value="${sessionScope.combo.getPrice()}"
                ...
                <div>
                  <input type="submit" class="btn btn-primary mb-3" value="Sửa Combo">
