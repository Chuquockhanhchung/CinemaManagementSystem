        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Thêm nhà cung cấp mới</a></li>
                </ol>
            </div>
            <!-- Row -->
            <div class="row">
                <div class="col-xl-12">
                    <div class="mb-3">
                        <ul class="d-flex align-items-center flex-wrap">
                            <li><a href="event.jsp"
                                   class="btn btn-primary">Danh sách nhà cung cấp</a></li>
                        </ul>
                    </div>
                    <form method="post" action="../../addsupplier">
                        <div class="row">
                            <div class="mb-3 col-sm-8">
                                ...
                                <input type="text" class="form-control" placeholder="Tên Nhà Cung Cấp" name="SupplierName">
                            </div>
                            <div class="col-xl-8">
