        ...
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="orders_list.jsp">Danh Sách Vé Đã Đặt</a></li>
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="../CMS/movies.jsp">Danh Sách Phim</a></li>
                    <li><a href="../CMS/add_movies.jsp">Thêm Phim Mới</a></li>
                    <li><a href="../CMS/event.jsp">Sự Kiện</a></li>
                    <li><a href="../CMS/add_event.jsp">Thêm Sự Kiện</a></li>
                    <li><a href="../CMS/product.jsp">Sản Phẩm</a>
                    <li><a href="../CMS/add_product.jsp">Thêm Sản Phẩm</a>
                    <li><a href="../CMS/voucher.jsp">Voucher</a>
                    <li><a href="../CMS/add_voucher.jsp">Thêm Voucher</a>
                    </li>
                </ul>
            </li>
