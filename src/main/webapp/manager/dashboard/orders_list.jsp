...
<head>
    ...
    <link href="${pageContext.request.contextPath}/public/assets/vendor/bootstrap-select/css/bootstrap-select.min.css" rel="stylesheet" type="text/css" />

    <link href="${pageContext.request.contextPath}/public/assets/vendor/bootstrap-datepicker-master/css/bootstrap-datepicker.min.css" rel="stylesheet" type="text/css" />

    <link class="main-css" href="${pageContext.request.contextPath}/public/assets/css/style.css" rel="stylesheet" type="text/css" />
                        ...
                        <table class="table mb-4 dataTablesCard card-table" id="orderTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="wspace-no"><%= ticket.getMovieName() %></td>
                                    <td><%= ticket.getFullName() %></td>
                                    <td></td>
                                    <td>1 pcs</td>
                                    <td><%= ticket.getStatus() %></td>
                                    <td class="text-black"><strong>NO</strong></td>
                                    <td><a href="javascript:void(0);" class="btn btn-secondary light btn-sm"><%= ticket.getTicketPrice() %></a></td>
                                </tr>
                                <%
                                    }
                                %>
