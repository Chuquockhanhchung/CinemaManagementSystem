        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                    <div class="st_bt_top_back_btn float_left"> <a href="index.jsp"><i class="fas fa-long-arrow-alt-left"></i> &nbsp;Back</a>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="st_cherity_btn float_left">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="confirmation_screen.jsp">Proceed to Pay </a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
