        ...
        <div class="container container_seat">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="st_bt_top_back_btn st_bt_top_back_btn_seatl float_left"> <a href="movie_booking.jsp"><i class="fas fa-long-arrow-alt-left"></i> &nbsp;Back</a>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <div class="st_seatlay_btn float_left"> <a href="booking_type.jsp">Proceed to Pay</a>
                    </div>
                </div>
            </div>
        </div>
