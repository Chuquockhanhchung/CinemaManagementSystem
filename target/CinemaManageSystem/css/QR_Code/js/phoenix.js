document.addEventListener("DOMContentLoaded", function () {
    ...
    tabs.forEach(tab => {
        tab.addEventListener("click", function () {
            ...
            // Lấy id của tab mà người dùng đã click
            const tabId = this.getAttribute("aria-controls");
            const targetPane = document.getElementById(tabId);

            // Thêm lớp active và show cho tab-pane tương ứng
...
$(document).ready(function () {
    ...
    // Khi hover vào ảnh nhỏ, chuyển đến ảnh tương ứng trong slider chính
    ...
    // Khi click vào ảnh nhỏ, chuyển đến ảnh tương ứng trong slider chính
