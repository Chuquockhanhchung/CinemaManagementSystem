                    ...
                    <ul class="navbar-nav header-right">
                        ...
                        <li class="nav-item dropdown header-profile">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="page_login" class="dropdown-item ai-icon">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="index">Dashboard Light</a></li>
                        <li><a href="index_2">Dashboard Dark</a></li>
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="app_profile">Profile</a></li>
                        <li><a href="post_details">Post Details</a></li>
                        <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Email</a>
                            <ul aria-expanded="false">
                                <li><a href="email_compose">Compose</a></li>
                                <li><a href="email_inbox">Inbox</a></li>
                                <li><a href="email_read">Read</a></li>
                            </ul>
                        </li>
                        <li><a href="app_calender">Calendar</a></li>
                        <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Shop</a>
                            <ul aria-expanded="false">
                                <li><a href="ecom_product_grid">Product Grid</a></li>
                                <li><a href="ecom_product_list">Product List</a></li>
                                <li><a href="ecom_product_details">Product Details</a></li>
                                <li><a href="ecom_product_order">Order</a></li>
                                <li><a href="ecom_checkout">Checkout</a></li>
                                <li><a href="ecom_invoice">Invoice</a></li>
                                <li><a href="ecom_customers">Customers</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="flat_icons">Flaticons</a></li>
                        <li><a href="svg_icons">SVG Icons</a></li>
                        <li><a href="feather_icons">Feather Icons</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="email_template">Email Template</a></li>
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="button_group">Button Group</a></li>
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="noui_slider">Noui Slider</a></li>
                        <li><a href="sweetalert">Sweet Alert</a></li>
                        <li><a href="toastr">Toastr</a></li>
                        <li><a href="map_jqvmap">Jqv Map</a></li>
                        <li><a href="lightgallery">Light Gallery</a></li>
                    </ul>
                </li>
                <li><a href="widget_basic" class="ai-icon" aria-expanded="false">
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="form_element">Form Elements</a></li>
                        <li><a href="form_wizard">Wizard</a></li>
                        <li><a href="form_ckeditor">CKeditor</a></li>
                        <li><a href="form_pickers">Pickers</a></li>
                        <li><a href="form_validation_jquery">Form Validate</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="table_bootstrap">Bootstrap</a></li>
                        <li><a href="table_datatable">Datatable</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="page_login">Page Login</a></li>
                        <li><a href="page_register">Register</a></li>
                        <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Error</a>
                            <ul aria-expanded="false">
                                <li><a href="page_error_400">Error 400</a></li>
                                <li><a href="page_error_403">Error 403</a></li>
                                <li><a href="page_error_404">Error 404</a></li>
                                <li><a href="page_error_500">Error 500</a></li>
                                <li><a href="page_error_503">Error 503</a></li>
                            </ul>
                        </li>
                        <li><a href="page_lock_screen">Lock Screen</a></li>
                        <li><a href="page_empty">Empty Page</a></li>
                    </ul>
                </li>
            </ul>
            <div class="plus-box">
                <p class="fs-16 font-w500 mb-3">Ticket Sales Weekly Report</p>
                <a class="text-white fs-14" href="analytics">Learn more</a>
            </div>
            <div class="copyright">
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-4 align-items-center">
                ...
                <div class="col-xl-3 mt-3 mt-xl-0 Generate">
                    <a href="#" class="btn btn-secondary d-block" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa fa-file-text-o scale5 me-3"></i>Generate Order Report</a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive table-hover fs-14">
                        <table class="table mb-4 dataTablesCard card-table" id="orderTable">
                            ...
                            <tbody>
                            <%
                                PaymentDAO paymentDAO = new PaymentDAO(DBContext.getConn());
                                List<Ticket> listTicket = paymentDAO.getTicket();

                                for (Ticket tickets : listTicket) {
                            %>
                            <tr>
                                <td>
                                    <div class="form-check checkbox-secondary">
                                ...
                                <td><%= tickets.getBookingDate() %></td>
                                <td class="wspace-no">Envato Interantional Meetup 2020</td>
                                <td><%= tickets.getFullName() %></td>
                                <td>London, US</td>
                                <td>1 pcs</td>
                                <td>567k left</td>
                                <td class="text-black"><strong>NO</strong></td>
                                <td><a href="javascript:void(0);" class="btn btn-secondary light btn-sm"><%= tickets.getTicketPrice() %></a></td>
                            </tr>
                            <% } %>
                            </tbody>
                        </table>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="#0012451">
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="mb-3">
                                    <label for="exampleFormControlInput2" class="form-label">Customer Name</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Frank Azire">
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <div class="mb-3">
                                    <label for="exampleFormControlInput3" class="form-label">Event NAME</label>
                                    <input type="email" class="form-control" id="exampleFormControlInput3" placeholder="UI Design Workshop With Best Author Envato 2020">
                                </div>
                            </div>
                        </div>
                    </form>
